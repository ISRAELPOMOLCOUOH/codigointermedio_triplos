window.onload = function(){
    ...
    document.getElementById("ejecutar").addEventListener("click",triplos);   
    function triplos(){
        var cadenaOriginal = document.getElementById("expresion").value;
        var cadenaPosfija = "";
        ...
        pilaFinal.push("\n"+"X = "+ pilaResultados.pop());//se quita el ultimo valor simplificado y se agrega a la pila final
        document.getElementById("nuevaExpresion").innerHTML = pilaFinal;
        return true;
        //return document.write(pilaFinal);

    }

    function simplificar(valor1,valor2,operador,n){//simplifica la operacion posfija en t1,t2,etc..
        var sim = "";
        sim = "\n"+"t" + n + " = "+ valor2 + operador + valor1; //se almacena la operacion ..ejemplo : sim = t0 = a*b
        return sim;
    }
